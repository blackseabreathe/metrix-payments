...
$params = [
    [
        "date" => "2022-02-28", // строка
        "sum" => "555,96", // строка или число, разделитель точка или запятая
        "deal" => 105507, // строка или число - Тестовая сделка
    ],
    [
        "date" => "2022-11-01",
        "sum" => 1000.11,
        "deal" => 105507, // Тестовая сделка
    ],
];
